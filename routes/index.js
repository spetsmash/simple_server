...
function newQuestion(msg, index){
    ...
    switch(index) {
        case 2:
            ...
            break;
        case 4:
            ask(msg, 'We will verify now that you have followed us on Twitter, please ENTER your TWITTER USERNAME. (without @)');
            break;
        case 5:
            ask(msg, 'Please ENTER you Ethereum wallet address:');
            break;
        case 6:
...
function sendEmailVerification (chat, email, id) {
    ...
    models.User
        ...
        .spread((user, created) => {
            const link = "https://ini-mw.act.foundation"+ "/verify?id=" + id + "&email="+ email;
            const message = {
                to: email,
...
router.get('/verify',function(req,res){
    ...
    if((req.protocol+"://"+req.get('host')) == ("https://ini-mw.act.foundation"))
    {
